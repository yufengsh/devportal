...
Catalog Service provides a set of REST APIs that can be used to automate updating a catalog's master image.
...
.. |figure_1| image:: _static/xenapp_essentials_apis/figure_1.png
	:target: https://catalogs.apps.cloud.com/swagger/ui/index
